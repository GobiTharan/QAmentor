...
public class AndroidCommandUtils {
	 ...
	 * @return
	 */
	public WebElement findElement(AndroidDriver driver, String inputData,String locateBy,
	...
	public Object executeAction(AndroidDriver driver, WebElement element,
		...
		case "JsClick":
			...
			break;
		case "AndroidClick":
			Manipulation.aclick(driver,element);
			break;
		case "DoubleClick":
		...
		case "VerifyElementIsPresent":
			returnObj = Manipulation.verifyElementIsPresentAndroid(driver, element);
			getTextMap.put(stepNo, returnObj.toString());
			break;
		...
		case "KeyboardHide":		
			...
			break;
		case "ClickUI":		
			driver.findElementByAndroidUIAutomator("new UiSelector().className(\"android.widget.LinearLayout\").index(0).instance(0).childSelector(new UiSelector().className(\"android.widget.TextView\").index(1));").click();
			break;	
		case "ScrollPage":
			Navigate.pageScrolldown(driver);
			break;
		case "ScrollPageToXpath":
			Navigate.Scrolldown(driver,normalXpath);
			break;
		case "ClickByResourceID":
			driver.findElementByAccessibilityId("resourceId(\"com.android.chrome:id/infobar_close_button\")").click();
			break;
