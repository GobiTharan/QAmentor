...
public class Navigate {
	...
	public static void get(WebDriver driver, String url) 
	{
		...
		driver.get(url);
		System.out.println("Platform.BROWSER_NAME : "+Platform.BROWSER_NAME);
		if (Platform.BROWSER_NAME.equalsIgnoreCase("ie")||Platform.BROWSER_NAME.equalsIgnoreCase("UnKnown"))
		{
