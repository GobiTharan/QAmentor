...
/**
 * Getting info of Browser Name and version, OS info and Driver info
 * @author BaPs
 *
 */
public class Platform {
	...
	public static void prepareDetails(WebDriver driver)  {
		...
		try
		{
			String str = (String)((JavascriptExecutor)driver).executeScript("return navigator.userAgent;", new Object[0]);
